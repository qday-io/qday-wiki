...
### How do users migrate assets and staking from the old QDay testnet/mainnet to the new QDay testnet/mainnet?
Staking migration bridge and asset migration bridge tools are being deployed. A step-by-step migration guide and updated FAQ will be provided once the migration bridges are active.

### What is the minimum staking amount for WABEL?
The minimum staking amount is 1,000 WABEL.
...
Of the total $QDAY supply of 22,517,998,100 tokens, 35.00% (7,881,299,335 tokens) is allocated to the Staking Rewards category, as specified in Section 3 (Tokenomics).
