...
:::tip[Prerequisites]
Before using, please ensure you have installed and set up the [MetaMask Wallet](/guide/handbook/user-guide/metamask) and [Added the QDAY Network](/guide/handbook/user-guide/metamask#add-qday-network-to-metamask).
:::
...
## Manage Positions and Transaction History
...
<NextSteps steps={[{ title: "QDAY Staking", desc: "Earn on your tokens", to: "/guide/handbook/user-guide/qday-staking" },{ title: "Chain parameters", desc: "Add QDay to your wallet", to: "/Knowledge/reference/chains" }]} />
