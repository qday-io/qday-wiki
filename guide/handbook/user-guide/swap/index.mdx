...
<NextSteps steps={[
  { title: "QDAY Staking", desc: "Earn on your tokens", to: "/guide/handbook/user-guide/qday-staking" },
  { title: "Chain parameters", desc: "Add QDay to your wallet", to: "/Knowledge/reference/chains" },
]} />
