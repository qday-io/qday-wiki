...
1. Visit [QDay Explorer](https://explorer-test.qday.info).
2. Click **"Add QDay Aevum"** (or the equivalent network button) in the upper right corner to add QDay to MetaMask automatically.
3. If MetaMask opens a network approval prompt, carefully review the network details before approving.
   ...
   - Block Explorer URL: https://explorer-test.qday.info
...
2. Click **"Add a custom network"** and fill in the following details:
   - **Network Name**: QDay Aevum
   - **Default RPC URL**: `https://rpc-test.qday.info`
   - **Chain ID**: 44005
   - **Currency Symbol**: tQDAY
   - **Block Explorer**: `https://explorer-test.qday.info`

   ![Manually Add QDay Network](/qday/metamask/add-metamask-network-en.png)

3. Click **"Save"** to jump to the QDay Aevum network.

:::info[Mainnet]
QDay mainnet is coming soon. Mainnet network parameters will be published here at launch.
:::
...
<NextSteps steps={[
  { title: "Get testnet tokens", desc: "Claim QDAY to pay for gas", to: "/guide/start/faucet" },
  { title: "Swap tokens", desc: "Trade WABEL / QDAY / USD8", to: "/guide/handbook/user-guide/swap" },
  { title: "Migrate to QDay", desc: "Move your assets one-way", to: "/Knowledge/migration/overview" },
]} />
