...
- An EVM-compatible wallet (MetaMask recommended) with QDay Aevum active.
...
:::warning[Note]
If you need to use the Abelian network (e.g., to hold ABEL for cross-chain conversion), please use the [Abelian mobile wallet application](/guide/handbook/user-guide/abelian-mobile-wallet).
:::
...
<NextSteps steps={[{ title: "QDAY Staking", desc: "Stake native QDAY", to: "/guide/handbook/user-guide/qday-staking" },{ title: "Bridge assets", to: "/guide/handbook/user-guide/abelian-bridge-v3" }]} />
