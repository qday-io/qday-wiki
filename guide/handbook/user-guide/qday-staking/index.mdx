...
Log into MetaMask and add the QDay Mainnet as a custom network. For detailed instructions, please refer to [MetaMask Wallet User Guide - Add QDay Network](/guide/handbook/user-guide/metamask#add-qday-network-to-metamask).
...
<NextSteps steps={[{ title: "ABEL Staking", desc: "Stake ABEL for yield", to: "/guide/handbook/user-guide/abel-staking" },{ title: "Swap tokens", desc: "Get WABEL / USD8", to: "/guide/handbook/user-guide/swap" },{ title: "Migrate to QDay2", to: "/Knowledge/migration/overview" }]} />
