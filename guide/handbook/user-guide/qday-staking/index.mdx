...
<NextSteps steps={[
  { title: "ABEL Staking", desc: "Stake ABEL for yield", to: "/guide/handbook/user-guide/abel-staking" },
  { title: "Swap tokens", desc: "Get WABEL / USD8", to: "/guide/handbook/user-guide/swap" },
  { title: "Migrate to QDay", to: "/Knowledge/migration/overview" },
]} />
