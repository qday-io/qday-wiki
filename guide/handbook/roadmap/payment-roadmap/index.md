...
Product context: [Why QDay](/guide/handbook/why-qday). Builder APIs: [Build on QDay — SDKs](/guide/handbook/build-on-qday#sdks) and [Payment SDK](/Knowledge/technical/developer-guide/getting-started#payment-sdk).
...
2. Integrate `@qday-io/sdk/payments` when the testnet gateway is announced ([Developer Guide](/Knowledge/technical/developer-guide/getting-started#payment-development)).
