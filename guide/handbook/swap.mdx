...
:::tip[Prerequisites]
Before using, please ensure you have installed and set up the [MetaMask Wallet](/guide/handbook/metamask) and [Added the QDAY Network](/guide/handbook/metamask#add-qday-network-to-metamask).
:::
...
<NextSteps steps={[{ title: "QDAY Staking", desc: "Earn on your tokens", to: "/guide/handbook/qday-staking" },{ title: "Chain parameters", desc: "Add QDay to your wallet", to: "/Knowledge/reference/chains" }]} />
