...
QDay 的**支付網絡**（第 1.5 階段）：以 USD8 作為記帳單位、提供商家使用的閘道，以及服務一般人與 **AI Agent** 的支付軌道。日常 dApp 的 Gas 仍以 QDAY 支付；**由 Agent 發起**的支付則設計為以 USD8 計費。
...
與網絡 [QDAY 路線圖](/guide/handbook/roadmap/qday-roadmap) 對齊：
