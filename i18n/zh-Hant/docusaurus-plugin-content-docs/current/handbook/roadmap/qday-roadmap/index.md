...
QDay 的產品與網絡計畫：先是建立於 Abelian 上、與 EVM 兼容的 Layer 2，接着是支付網絡，最後是原生抗量子帳戶。
...
| **第 1.5 階段（Phase 1.5）** | 支付網絡：USD8、發票、商家、代理支付 | 同一個 L2；支付成為第一級層 |
...
新增網絡：[快速開始](/guide/start/add-network)。參數：[鏈參數](/Knowledge/reference/chains)。
