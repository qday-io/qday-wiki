...
QDay Aevum 使用 Polygon CDK Global Exit Root 作為本 rollup 與其他共用同一 exit-root 樹的鏈之間的訊息傳遞基礎。[跨鏈橋協定](/Knowledge/technical/protocol/bridge-protocol)上的資產鎖定，會在對應的 exit root 提交後成為目標鏈上可領取的資產。
