...
2. Point apps and RPC configs at the Aevum endpoint when you start building or testing on QDay 2 — [Network Configuration](/Knowledge/technical/developer-guide/network-configuration).
