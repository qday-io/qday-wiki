...
**JSON-RPC** — QDay Aevum exposes a fully Ethereum-compatible JSON-RPC interface (`eth_*`, `net_*`, `web3_*`). Any tool that can talk to an Ethereum node (MetaMask, ethers.js, viem, Foundry cast) connects to QDay Aevum without modification.
