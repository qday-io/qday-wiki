...
QDay Aevum's security design rests on three pillars:
...
**Minimal trust surface** — QDay Aevum inherits the Polygon CDK's extensively audited contract codebase. QDAY-specific extensions (Committer, Record Contracts, Abelian Plus Node) are scoped narrowly and do not hold user funds.
