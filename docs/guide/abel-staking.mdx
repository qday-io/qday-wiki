...
:::warning[Note]
If you need to use the Abelian network (e.g., to hold ABEL for cross-chain conversion), please use the [Abelian mobile wallet application](/docs/guide/abelian-mobile-wallet).
:::
...
<NextSteps steps={[{ title: "QDAY Staking", desc: "Stake native QDAY", to: "/docs/guide/qday-staking" },{ title: "Bridge assets", to: "/docs/guide/abelian-bridge-v3" }]} />
